...
if Rails.env.development?
  kevin = User.create({"name"=> "Kevin", "surname"=> "Levin", "email"=> "kevin@gmail.com", "phone"=> "987654321", "phone_code"=> 51, "gender"=> 0, "birthdate"=> "1999-01-01", "locale"=>"es", "country"=> "Peru", "city"=> "Lima", "deleted_at"=> nil, "password"=> "k234234234", "password_confirmation"=> "k234234234", "confirmed_at"=> Time.current})
  lucero = User.create({"name"=> "Lucero", "surname"=> "Lero", "email"=> "lucero@gmail.com", "phone"=> "987654322", "phone_code"=> 51, "gender"=> 1, "birthdate"=> "1999-01-01", "locale"=>"es", "country"=> "Peru", "city"=> "Lima", "deleted_at"=> nil, "password"=> "k234234234", "password_confirmation"=> "k234234234", "confirmed_at"=> Time.current})
